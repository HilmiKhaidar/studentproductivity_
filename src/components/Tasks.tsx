  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold text-white">Manajemen Tugas</h2>
          <p className="text-white/70 mt-1">Kelola semua tugas dan deadline kamu</p>
        </div>
        <button
          onClick={() => {
            setEditingTask(null);
      ...
      <div className="space-y-3">
        {filteredTasks.length === 0 ? (
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-12 border border-white/20 text-center">
            <p className="text-white/70 text-lg">Tidak ada tugas ditemukan</p>
          </div>
        ) : (
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-3 mt-3">
                        <span className={`${getCategoryColor(task.category)} text-white text-xs px-3 py-1 rounded-full`}>
                          {task.category}
                        </span>
                        <span className={`${getPriorityColor(task.priority)} text-white text-xs px-3 py-1 rounded-full`}>
                          {task.priority}
                        </span>
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-purple-900/90 to-indigo-900/90 backdrop-blur-lg rounded-2xl p-6 max-w-2xl w-full border border-white/20 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-white/90 text-sm font-medium mb-2">Judul Tugas</label>
            <input
              type="text"
              required
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-white/90 text-sm font-medium mb-2">Prioritas</label>
              <select
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-white/90 text-sm font-medium mb-2">Deadline</label>
              <input
                type="date"
                required
            ...
            <div>
              <label className="block text-white/90 text-sm font-medium mb-2">Estimasi Waktu (menit)</label>
              <input
                type="number"
                required
                min="1"

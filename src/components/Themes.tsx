  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="notion-text-secondary text-sm mt-2">Personalisasi tampilan aplikasimu</p>
      </div>

      {/* Theme Selection */}
      <div className="notion-card p-6">
        <h3 className="text-lg font-semibold notion-heading mb-4">Pilih Theme</h3>
      ...
      <div className="notion-card p-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="notion-text font-medium">Compact Mode</p>
            <p className="notion-text-secondary text-sm">Tampilan lebih padat dan efisien</p>
          </div>
          <button
      ...
      {/* Preview */}
      <div className="notion-card p-6">
        <h3 className="text-lg font-semibold notion-heading mb-4">Preview</h3>
        <div className="space-y-4">
          <div className="notion-card p-4">
            <h4 className="text-lg font-bold notion-text mb-2">Sample Card</h4>
            <p className="notion-text-secondary">
              Ini adalah contoh tampilan card dengan theme yang kamu pilih.
            </p>
            <div className="flex gap-2 mt-3">
              <button className="notion-button-primary notion-text px-4 py-2 rounded-lg text-sm font-semibold">
                Primary Button
              </button>
              <button className="bg-white/10 notion-text px-4 py-2 rounded-lg text-sm font-semibold">
                Secondary Button
              </button>
            </div>
          </div>
